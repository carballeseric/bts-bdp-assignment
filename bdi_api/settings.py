...
class Settings(BaseSettings):
    ...
    neo4j_url: str = Field(
        ...
        description="Neo4J connection URL. Set BDI_NEO4J_URL to override.",
    )
    neo4j_user: str = Field(
        default="neo4j",
        description="Neo4J username. Set BDI_NEO4J_USER to override.",
    )
    neo4j_password: str = Field(
        default="password",
        description="Neo4J password. Set BDI_NEO4J_PASSWORD to override.",
    )
